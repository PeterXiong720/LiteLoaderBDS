...
static_assert(sizeof(AddPlayerPacket) == 0x368, "size of AddPlayerPacket should be 872");
...
static_assert(sizeof(AddPlayerPacket) == 0x368 || sizeof(AddPlayerPacket) == 48, "size of AddPlayerPacket should be 872 or 48(default)");
