...
public:
    class NpcSceneDialogueData& operator=(class NpcSceneDialogueData const&) = default;
    NpcSceneDialogueData(class NpcSceneDialogueData const&) = default;
    NpcSceneDialogueData() = default;
#endif
